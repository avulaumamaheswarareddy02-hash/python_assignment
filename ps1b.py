...
semi_annual_rise  = float(input("enter semi annual rise :"))
# user enters his semi annual rise.
...
while savings < down_payment:                      # loop runs while the condition is true.
    ...
    if months % 6 == 0:                            # checks month is divisible by 6 or not to add semi - annual rise.
        
        annual_salary += annual_salary * semi_annual_rise    # it calculates total salary with semi annual rise and adds to annual salary.
        
        monthly_salary = annual_salary / 12                  # calculates monthly salary using annual salary after semi annual rise.
        
print(f"no of months = {months}")                  # prints number of months.